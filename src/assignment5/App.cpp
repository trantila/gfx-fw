	...
	m_normalMapScale(0.15f)
{
    ...
    m_window.setTitle("Assignment 5");
    m_window.addListener(this);
    m_window.addListener(&m_commonCtrl);

	m_commonCtrl.setStateFilePrefix( "Assignment5" );
...
void App::renderWithNormalMap(GLContext* gl, Mat4f worldToCamera, Mat4f projection)
{
	...
	// we're only using two lights, and they're hard-coded.
	// feel free to do something creative here!
	Vec3f lightDir[] = { Vec3f( 1, 0, 1 ), Vec3f( -1, -1, 0 ) };
	Vec3f I[] = { Vec3f( 1, 1, 1 ), Vec3f( 0.3, 0.2, 0.2 ) };
